  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center hero-gradient overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-10 -left-20 w-80 h-80 rounded-full bg-primary/5 blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center gap-8 pt-24">
          ...
          <div className="text-center max-w-2xl">
            <p className="text-foreground/60 text-sm font-medium tracking-widest uppercase mb-4 animate-fade-up" style={{ animationDelay: "0.2s" }}>
              Creative Branding & Print Design Specialist
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6 animate-fade-up" style={{ animationDelay: "0.25s" }}>
              Julian D Costa
            </h1>
            <p className="text-lg text-primary mb-4 font-light animate-fade-up" style={{ animationDelay: "0.3s" }}>
              Professional Graphics Designer
            </p>
            <p className="text-muted-foreground max-w-lg mx-auto mb-8 leading-relaxed text-justify animate-fade-up" style={{ animationDelay: "0.35s" }}>
